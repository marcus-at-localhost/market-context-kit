...
- Triggered by `/marketkit:report-pdf` or `/marketkit:report-pdf <domain>`
...
- Footer: "Generated by Market Context Kit for Claude Code"
...
1. Run `/marketkit:audit <url>` -- Generates comprehensive audit data
2. Run `/marketkit:competitors <url>` -- Adds competitor comparison data
3. Run `/marketkit:seo <url>` -- Adds detailed SEO findings
4. Run `/marketkit:landing <url>` -- Adds CRO analysis
5. Run `/marketkit:report-pdf <url>` -- Compiles everything into a PDF
