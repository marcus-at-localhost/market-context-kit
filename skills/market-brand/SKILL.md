...
- Triggered by `/ai-marketing:market-brand <url>` or `/ai-marketing:market-brand`
...
- If the user has run `/ai-marketing:market-competitors` previously, use that data for the competitor voice comparison section.
