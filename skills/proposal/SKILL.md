---
name: proposal
description: Use when the user is pitching a prospect and needs a marketing services proposal — scope, pricing tiers, ROI projections, timeline, and next steps.
...
- Triggered by `/marketkit:proposal` or `/marketkit:proposal <client name>`
